...
The Sphinx build exports the CSV tables from the page folders under ``docs/content/pages/`` to a SQLite database at ``docs/_build/html/database/boolean_wiki.db``.
