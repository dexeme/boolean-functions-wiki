...
Content partially extracted from ``data/Some_APN_functions_CCZ-equivalent_to_x%5E3_%2B_tr_n(x%5E9)_and_CCZ-inequivalent_to_the_Gold_functions_over_GF(2%5En).txt``.
Original page:
...
Overview
--------
Some APN functions `CCZ`-equivalent to `x^3+{\mathrm Tr}_{n}(x^9)` 
and CCZ-inequivalent to the Gold functions over `\mathbb{F}_{2^n}`

Cases regarding Proposition 3 of :cite:p:`Budaghyan:200904`

.. csv-table::
    :file: ../tables/Some_APN_functions_CCZ_equivalent_to_x_pow_3_plus_tr_n_x_pow_9_and_CCZ_inequivalent_to_the_Gold_functions_over_GF_2_pow_n_table_01.csv
    :header-rows: 1
    :widths: 2 45 15 2
    :font-size: -3 -1 -1 -1
