.. _known_instances_of_apn_functions_over_gf_2_pow_8:

Known instances of APN functions over GF(2^8)
=============================================

Content partially extracted from ``data/Known_instances_of_APN_functions_over_GF(2%5E8).txt``.
Original page:

:link:`https://boolean.wiki.uib.no/Known_instances_of_APN_functions_over_GF(2%5E8)  <https://boolean.wiki.uib.no/Known_instances_of_APN_functions_over_GF(2%5E8)>`
